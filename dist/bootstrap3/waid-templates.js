angular.module('waid.templates',[]).run(['$templateCache', function($templateCache) { 
  ...
  $templateCache.put('/templates/comments/comment-item.html?v=0.0.41',
    "\n" +
  ...
  $templateCache.put('/templates/comments/comments-home.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "  <div class=\"comment\"> \n" +
    "    <div class=\"media\">\n" +
  ...
  $templateCache.put('/templates/comments/comments-order-button.html?v=0.0.41',
    "\n" +
  ...
  $templateCache.put('/templates/core/core.html?v=0.0.41',
  ...
  $templateCache.put('/templates/core/datepicker/datepicker.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/core/datepicker/day.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/core/datepicker/month.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "<table role=\"grid\" aria-labelledby=\"{{::uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n" +
    "  <thead>\n" +
    "    <tr>\n" +
  ...
  $templateCache.put('/templates/core/datepicker/year.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "<table role=\"grid\" aria-labelledby=\"{{::uniqueId}}-title\" aria-activedescendant=\"{{activeDateId}}\">\n" +
    "  <thead>\n" +
    "    <tr>\n" +
  ...
  $templateCache.put('/templates/core/datepickerPopup/popup.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/core/emoticons-modal.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/core/modal/window.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/idm/associated-social-accounts.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/idm/complete-profile-modal.html?v=0.0.41',
    "<span class=\"waid\">\n" +
    "	<div class=\"modal-header\">\n" +
  ...
  $templateCache.put('/templates/idm/home.html?v=0.0.41',
    ""
  );


  $templateCache.put('/templates/idm/link-social-profile-modal.html?v=0.0.41',
    "<span class=\"waid\">\n" +
    "	<div class=\"modal-header\">\n" +
  ...
  $templateCache.put('/templates/idm/link-social-profile.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    " <div>\n" +
  ...
  $templateCache.put('/templates/idm/login-and-register-home.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "  <div class=\"row\">\n" +
    "    <div class=\"col-md-4\">\n" +
  ...
  $templateCache.put('/templates/idm/login-and-register-modal.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "	<div class=\"modal-header\">\n" +
  ...
  $templateCache.put('/templates/idm/login.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "  <div id=\"login_view\">\n" +
  ...
  $templateCache.put('/templates/idm/lost-login-modal.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "	<div class=\"modal-header\">\n" +
  ...
  $templateCache.put('/templates/idm/lost-login.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/idm/overview.html?v=0.0.41',
    "\n" +
  ...
  $templateCache.put('/templates/idm/profile.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "  <div class=\"row\">\n" +
    ...
    "                    <label>\n" +
    "                      <input type=\"checkbox\" ng-model=\"model[fieldDefinition.name][row.id]\" ng-change=\"fieldChange(fieldDefinition.name)\"> {{ row.name }}\n" +
    "                    </label>\n" +
    "                  </div>\n" +
    "                  <div class=\"alert alert-danger\" ng-repeat=\"error in errors[fieldDefinition.name]\"><span class=\"glyphicon glyphicon-alert\" aria-hidden=\"true\"></span> {{error}}</div>\n" +
    "                </div>\n" +
  ...
  $templateCache.put('/templates/idm/register.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    " <div>\n" +
  ...
  $templateCache.put('/templates/idm/social-login.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "  <div id=\"login_view\">\n" +
  ...
  $templateCache.put('/templates/idm/terms-and-conditions-modal.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "	<div class=\"modal-header\">\n" +
  ...
  $templateCache.put('/templates/idm/user-profile-modal.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "  <div class=\"modal-header\">\n" +
  ...
  $templateCache.put('/templates/idm/user-profile-navbar.html?v=0.0.41',
    "<div class=\"waid\">\n" +
  ...
  $templateCache.put('/templates/idm/user-profile-status-button.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "	<div class=\"btn-group\">\n" +
  ...
  $templateCache.put('/templates/rating/widget.html?v=0.0.41',
    "<div class=\"waid\">\n" +
    "  <span>Rate</span>\n" +
