angular.module('waid.templates',[]).run(['$templateCache', function($templateCache) { 
  ...
  $templateCache.put('/idm/templates/comments-home.html',
    ...
    "              <span class=\"glyphicon glyphicon-pencil\" aria-hidden=\"true\"></span> Post als {{ waid.user.default_name }}\n" +
    "          </button>\n" +
    "        </div>\n" +
    "      </div>\n" +
    "    </div>\n" +
    ...
    "                <span class=\"glyphicon glyphicon-edit\" aria-hidden=\"true\"></span>Edit comment</a>\n" +
    "              </li>\n" +
    "              <li ng-show=\"!comment.marked_as_spam\"><a ng-click=\"markComment(comment, 'SPAM')\">\n" +
    "                <span class=\"glyphicon glyphicon-exclamation-sign aria-hidden=\"true\"></span> Mark as spam</a>\n" +
    "              </li>\n" +
    "              <li role=\"separator\" class=\"divider\" ng-show=\"comment.is_owner\"></li>\n" +
    "              <li><a ng-click=\"deleteComment(comment)\" ng-show=\"comment.is_owner\" confirm=\"Weet u het zeker?\" confirm-title=\"Remove comment?\">\n" +
    "                <span class=\"glyphicon glyphicon-remove-sign\" aria-hidden=\"true\"></span> Delete comment</a>\n" +
    "              </li>\n" +
    "            </ul>\n" +
    "          </div>\n" +
    "        </h4>\n" +
    ...
    "            <span class=\"glyphicon glyphicon-exclamation-sign aria-hidden=\"true\"></span> Marked as spam\n" +
    "          </small>\n" +
    "        </div>\n" +
    ...
    "            <span class=\"glyphicon glyphicon-check\" aria-hidden=\"true\"></span> Update comment\n" +
    "          </button>\n" +
    "          </p>\n" +
    "        </div>\n" +
    "      </div>\n" +
  ...
  $templateCache.put('/idm/templates/comments-order-button.html',
    "<div class=\"btn-group\">\n" +
    "  <button type=\"button\" class=\"btn btn-default btn-xs dropdown-toggle\" data-toggle=\"dropdown\" aria-haspopup=\"true\" aria-expanded=\"false\">\n" +
    "     <span class=\"glyphicon glyphicon-sort\"></span> \n" +
    "     <span ng-show=\"ordering=='-created'\">Newest first</span>\n" +
    "     <span ng-show=\"ordering=='created'\">Oldest first</span>\n" +
    "     <span ng-show=\"ordering=='-vote_count'\">Top votes</span><span class=\"caret\"></span>\n" +
    "  </button>\n" +
    "  <ul class=\"dropdown-menu\">\n" +
    "    <li><a href=\"#\" ng-click=\"orderCommentList('-created')\"><span class=\"glyphicon glyphicon-sort-by-attributes-alt\"></span> Newest first </a></li>\n" +
    "    <li><a href=\"#\" ng-click=\"orderCommentList('created')\"><span class=\"glyphicon glyphicon-sort-by-attributes\n" +
    "        \"></span> Oldest first</a></li>\n" +
  ...
  $templateCache.put('/idm/templates/idm.html',
    " <div growl></div>"
  );
  ...
  $templateCache.put('/idm/templates/page.html',
  ...
  $templateCache.put('/idm/templates/user-profile-home.html',
    "\n" +
    "<div class=\"row\" ng-controller=\"WAIDUserProfileHomeCtrl\">\n" +
    "  <div class=\"col-md-4\">\n" +
