 ...
 */
  ...
  .directive('uibModalWindow', ['$uibModalStack', '$q', '$animateCss', '$document', 'waidCore',
...
.controller('UibDatepickerPopupController', ['$scope', '$element', '$attrs', '$compile', '$log', '$parse', '$window', '$document', '$rootScope', '$uibPosition', 'dateFilter', 'uibDateParser', 'uibDatepickerPopupConfig', '$timeout', 'uibDatepickerConfig', '$datepickerPopupLiteralWarning', 'waidCore',
function($scope, $element, $attrs, $compile, $log, $parse, $window, $document, $rootScope, $position, dateFilter, dateParser, datepickerPopupConfig, $timeout, datepickerConfig, $datepickerPopupLiteralWarning, waidCore) {
  ...
  this.init = function(_ngModel_) {
    ...
    datepickerPopupTemplateUrl = waidCore.config.getTemplate('/core/bootstrap3/templates/datepickerPopup/popup.html')

    datepickerTemplateUrl = waidCore.config.getTemplate('/core/bootstrap3/templates/datepicker/datepicker.html')
